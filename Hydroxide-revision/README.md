...
local function webImport(file)
    return loadstring(game:HttpGetAsync(("https://raw.githubusercontent.com/TotailyNotAScripter/testtesttest/main/Hydroxide-revision/README.md"):format(owner, branch, file)), file .. '.lua')()
end
